...
pub enum ControlOpcode {
    CIPHER_CREATE_SESSION = opcode(ServiceCode::CIPHER, 0x02),
    CIPHER_DESTROY_SESSION = opcode(ServiceCode::CIPHER, 0x03),
    HASH_CREATE_SESSION = opcode(ServiceCode::HASH, 0x02),
    HASH_DESTROY_SESSION = opcode(ServiceCode::HASH, 0x03),
    MAC_CREATE_SESSION = opcode(ServiceCode::MAC, 0x02),
    MAC_DESTROY_SESSION = opcode(ServiceCode::MAC, 0x03),
    AEAD_CREATE_SESSION = opcode(ServiceCode::AEAD, 0x02),
    AEAD_DESTROY_SESSION = opcode(ServiceCode::AEAD, 0x03),
    AKCIPHER_CREATE_SESSION = opcode(ServiceCode::AKCIPHER, 0x04),
    AKCIPHER_DESTROY_SESSION = opcode(ServiceCode::AKCIPHER, 0x05),
}
...
const CIPHER_SESSION_FLF_PADDING_SIZE: usize =
    SYM_SESS_OP_SPEC_HDR_SIZE - size_of::<CipherSessionFlf>();
...
#[allow(non_camel_case_types)]
pub enum DataOpcode {
    CIPHER_ENCRYPT = opcode(ServiceCode::CIPHER, 0x00),
    CIPHER_DECRYPT = opcode(ServiceCode::CIPHER, 0x01),
    HASH = opcode(ServiceCode::HASH, 0x00),
    MAC = opcode(ServiceCode::MAC, 0x00),
    AEAD_ENCRYPT = opcode(ServiceCode::AEAD, 0x00),
    AEAD_DECRYPT = opcode(ServiceCode::AEAD, 0x01),
    AKCIPHER_ENCRYPT = opcode(ServiceCode::AKCIPHER, 0x00),
    AKCIPHER_DECRYPT = opcode(ServiceCode::AKCIPHER, 0x01),
    AKCIPHER_SIGN = opcode(ServiceCode::AKCIPHER, 0x02),
    AKCIPHER_VERIFY = opcode(ServiceCode::AKCIPHER, 0x03),
}
...
pub enum CipherOpcode {
    ENCRYPT = opcode(ServiceCode::CIPHER, 0x00),
    DECRYPT = opcode(ServiceCode::CIPHER, 0x01),
}
...
#[repr(u32)]
pub enum AeadOpcode {
    ENCRYPT = opcode(ServiceCode::AEAD, 0x00),
    DECRYPT = opcode(ServiceCode::AEAD, 0x01),
}
...
pub enum AkcipherOpcode {
    ENCRYPT = opcode(ServiceCode::AKCIPHER, 0x00),
    DECRYPT = opcode(ServiceCode::AKCIPHER, 0x01),
    SIGN = opcode(ServiceCode::AKCIPHER, 0x02),
    VERIFY = opcode(ServiceCode::AKCIPHER, 0x03),
}
...
impl AlgChainDataFlf {
    pub fn new(
        dst_data_len: u32,
        cipher_start_src_offset: u32,
        len_to_cipher: u32,
        hash_start_src_offset: u32,
        len_to_hash: u32,
        hash_result_len: u32,
    ) -> Self {
        Self {
